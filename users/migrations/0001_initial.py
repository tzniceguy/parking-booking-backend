    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.CharField(blank=True, choices=[('nida', 'kitambulisho cha nida'), ('kura', 'kitambulisho cha mpiga kura'), ('leseni', 'leseni ya udereva'), ('pasipoti', 'hati ya kusafiria')], max_length=30, null=True)),
